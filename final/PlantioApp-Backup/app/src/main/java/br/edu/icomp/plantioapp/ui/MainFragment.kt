...
//        super.onResume()
//
//        val sensorList: List<Sensor> = sensorManager!!.getSensorList(Sensor.TYPE_LIGHT)
//
//        for (el in sensorList) sensorListString += """ ${el.name} """
//
//        Log.println(Log.INFO, "PLANTIO_TEST", sensorListString );
//        Log.println(Log.INFO, "PLANTIO_TEST", sensorListString);
//
...
//        }
        ...
        try {
            ...
            Log.println(Log.INFO, "PLANTIO_SENSOR", sensorListString)
